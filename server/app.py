...
def donor_kvpage(con, did):
    ...
    if avs or tier == 'יששכר_זבולון':
        ...
        lines.append(('בנוסף לאברכים הלומדים ומתפללים בחצות לילה לזכותו, ובנוסף לזה ' if len(avs) > 1
                      else 'בנוסף לאברך הלומד ומתפלל בחצות לילה לזכותו, ובנוסף לזה ') + KV_GEN)
    if tier in KV_DESC:
